...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\linewidth]{ch2_pdm_theorie/abbildungen/pdm_framework.pdf}};
...
\hyperref[eq:timeseries_matrix]{Gl. \Ref*{eq:timeseries_matrix}} definieren. $x_{i}^{j}$ ist der $i$-te Skalar der $j$-ten Dimension einer Serie $S$.
